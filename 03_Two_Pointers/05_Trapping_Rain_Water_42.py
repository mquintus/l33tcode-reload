class Solution:
    def trap(self, height: List[int]) -> int:
        '''
        This problem when approached as a two pointer problem
        consists of two steps.
        First, we acknowledge that any water between 
        the two most outward poles of height 1 is captured.
        Second, any pole in between reduces the amount of water.
        '''
